    ...
    const products = [
        {
            ...
            description: 'ACDC Back N Black Lid with Gold Red Blue Body, all Black buttons, 2" White trackball, Silver spinner, Atari DB-9 port. 8ft detachable USB cable, heavy duty design. Patent pending by designer AgentiLoop.ai. Compatible with Windows, Mac, Linux, Raspberry Pi, PS3.',
            price: 399.99,
            image: './images/superbox64acdcbackinblack-newsuperbox64bodystyle.JPG',
            altText: 'SuperBox64 ACDC Back N Black USB Arcade Controller - Retro Gaming Joystick Trackball Spinner - Windows Mac Linux Raspberry Pi PS3 - Custom Arcade Stick DB9 Port - AgentiLoop.ai Designer - Fighting Game Controller',
        ...
        },
        {
            ...
            altText: 'SuperBox64 Yellow Trackball Gaming Console - Raspberry Pi5 Retro Arcade System - Yellow Trackball Joystick Spinner - SuperBox64OS Preinstalled - Retro Emulation Console - Custom Gaming System AgentiLoop.ai - Arcade Machine Console',
    ...
    function renderProducts() {
        ...
        const usbHeader = `
            <div class="products-section-header" style="grid-column: 1 / -1; text-align: center;">
                <h2 style="font-family: 'CCUpUpAndAway', 'Press Start 2P'; font-size: 2.4rem; color: #fff; text-shadow: 0 0 10px rgba(0,123,255,0.3); margin: 0;">USB Retro Arcade Game Controllers</h2>
        ...
        const consoleHeader = `
            <div class="products-section-header" style="grid-column: 1 / -1; text-align: center;">
                <h2 style="font-family: 'CCUpUpAndAway', 'Press Start 2P'; font-size: 2.4rem; color: #fff; text-shadow: 0 0 10px rgba(0,123,255,0.3); margin: 0;">Pi5 Retro Arcade Emu Game Consoles</h2>
